...
def price_count(message, price=23):
    """
        returns 2 digits: count of rubles and pennies
        that u need to pay for send message with price
        for one letter
    """
    return divmod((len(message) * price), 100)


if __name__ == '__main__':
    print('{0} р. {1} коп.'.format(*price_count(input('message: '))))